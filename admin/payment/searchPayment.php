...
// Cập nhật SQL với JOIN và tìm kiếm theo các trường
$sql = "SELECT payments.paymentDate, payments.amount, payments.orderNumber, 
        ...
        WHERE customers.customerName LIKE '%$searchText%' 
           OR customers.phone LIKE '%$searchText%' 
           OR customers.address LIKE '%$searchText%' 
           OR payments.paymentDate LIKE '%$searchText%' 
           OR payments.amount LIKE '%$searchText%' 
           OR payments.orderNumber LIKE '%$searchText%'
...
<div id="main">
    ...
    <table id="payments" cellpadding="0" cellspacing="0" width="100%">
        ...
        <?php
            ...
            echo '<tr><td colspan="6">Không tìm thấy kết quả nào!</td></tr>';
        }
        ?>
    </table>
    <p id="pagination">
